...
migrate((app) => {
  const collection_LabelTrack = new Collection({
    id: "pb_03xhgjzhymxc1pg",
    name: "LabelTrack",
    type: "base",
  ...
  return app.save(collection_LabelTrack);
}, (app) => {
  const collection_LabelTrack = app.findCollectionByNameOrId("LabelTrack");
  return app.delete(collection_LabelTrack);
});

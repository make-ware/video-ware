  ...
  describe('getPaginatedTimelineClips', () => {
    it('should fetch with default pagination', async () => {
      ...
      expect(mockGetList).toHaveBeenCalledWith(1, 100, {
        expand:
          'TimelineRef,MediaRef,MediaRef.UploadRef,MediaRef.proxyFileRef,MediaRef.thumbnailFileRef,MediaRef.spriteFileRef,MediaRef.filmstripFileRefs,MediaClipRef,CaptionRef,SourceTimelineRef',
